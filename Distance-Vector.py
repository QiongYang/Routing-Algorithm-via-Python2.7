...
def Bellman_ford(aGraph,vertexlist,start):
    print ''''The Bellamn_ford's shortest path is'''
...
if __name__ == '__main__':
    ...
    Bellman_ford(g, lines,g.get_vertex(initial_station)) 
    target = g.get_vertex(final_station)
    #Bellman_ford(g, lines,g.get_vertex('Zhaojiabang Rd'))
